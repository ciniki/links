...
function ciniki_links_linkHistory($ciniki) {
    ...
    $rc = ciniki_links_checkAccess($ciniki, $args['tnid'], 'ciniki.links.linkHistory');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }

    ciniki_core_loadMethod($ciniki, 'ciniki', 'core', 'private', 'dbGetModuleHistory');
    return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.links', 'ciniki_link_history', $args['tnid'], 'ciniki_links', $args['link_id'], $args['field']);
}
?>
