...
// -------
//
function ciniki_links_hooks_webOptions(&$ciniki, $business_id, $args) {
    ...
    $rc = ciniki_core_dbDetailsQueryDash($ciniki, 'ciniki_web_settings', 'business_id', $business_id, 'ciniki.web', 'settings', 'page-links');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
